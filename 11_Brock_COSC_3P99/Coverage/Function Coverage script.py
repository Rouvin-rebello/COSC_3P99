...
if __name__ == "__main__":
    ...
    test_file_path = "Shopping_cart_project_tests.py"  # Replace with your actual test file path
    source_file_path = "Shpping_cart_project.py"  # Replace with your actual source file path
