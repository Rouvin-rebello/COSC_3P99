...
def check_win(board):
    ...
    # Integration point: ensure that the lines checked are correctly formed
    assert len(lines) == 8, "Invalid number of lines to check for win"
    for line in lines:
