...
if __name__ == "__main__":
    source_file = "../Project_3/6_Play/Function_6_UI.py"
    test_file = "../Project_3/6_Play/Modified_Test_File.py"

    #change the function name in the line below!!
    coverage_percent = measure_coverage(source_file, test_file, "play")
