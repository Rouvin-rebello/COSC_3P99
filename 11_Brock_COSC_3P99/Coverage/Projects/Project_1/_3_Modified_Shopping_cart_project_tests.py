import pytest
from Split_1_core_functionality import calculate_total
from Split_3_output_consistency import Item, Order
from Split_2_integration_points import DynamicallyPricedItem
...
def test_Order_calculate_order_total(mocker):
    ...
    total_mock = mocker.patch(
        'core_functionality.calculate_total', return_value=110.25)
