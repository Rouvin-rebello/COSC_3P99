...
if __name__ == "__main__":
    ...
    source_file = "Split_1_core_functionality.py"
    #source_file = "Split_2_integration_points.py"
    #source_file = "Split_3_output_consistency.py"
    test_file = "_3_Modified_Shopping_cart_project_tests.py"
