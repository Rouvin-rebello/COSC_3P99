...
if __name__ == "__main__":
    source_file = os.path.join(script_dir, "7_mixins_update/boundary_conditions.py")
    test_file = os.path.join(script_dir, "test_hitbox.py")
    ...
    coverage_percent = measure_coverage(source_file, test_file, "update")
